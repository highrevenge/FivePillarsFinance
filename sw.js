 ...
 */
const CACHE_VERSION = "v2"; // bumped: Firebase migration changed the app shell
const CACHE_NAME = "five-pillar-finance-" + CACHE_VERSION;

// The app shell: everything needed to load and use the app while offline.
// Note: with the Firebase migration, actually SIGNING IN, loading your
// dashboard data, and saving changes all need a live connection (they talk
// to Firebase's servers) — offline mode now mainly means "the page itself
// loads instantly," not full offline functionality like the old
// localStorage-only version had.
const APP_SHELL = [
  "./",
  "./index.html",
  "./dashboard.html",
